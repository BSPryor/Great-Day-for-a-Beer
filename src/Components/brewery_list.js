...
export default function BreweryList({ breweries, coords }) {
  ...
  return (
    <div>
      ...
      <br></br>
      { isHot && <h2>It will be cooler at <Moment unix format="h:mm a" tz="America/New_York" >{forecast.dt}</Moment> Eastern</h2>}
